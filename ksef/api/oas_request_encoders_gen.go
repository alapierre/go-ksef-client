...
func encodePermissionsQueryEntitiesGrantsPostRequest(
	req OptEntityPermissionsQueryRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
...
func encodeTestdataContextBlockPostRequest(
	req OptBlockContextAuthenticationRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
...
func encodeTestdataContextUnblockPostRequest(
	req OptUnblockContextAuthenticationRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
