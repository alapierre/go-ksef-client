...
func decodeAuthChallengePostResponse(resp *http.Response) (res AuthChallengePostRes, _ error) {
	...
	case 400:
		...
		case ct == "application/problem+json":
			...
			var response BadRequestProblemDetails
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 429:
		...
		case ct == "application/problem+json":
			...
			var response TooManyRequestsProblemDetails
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper TooManyRequestsProblemDetailsHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "Retry-After" header.
			{
...
func decodeAuthReferenceNumberGetResponse(resp *http.Response) (res AuthReferenceNumberGetRes, _ error) {
	...
	case 401:
		...
		case ct == "application/problem+json":
			...
			var response UnauthorizedProblemDetails
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/problem+json":
			...
			var response ForbiddenProblemDetails
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 410:
		...
		case ct == "application/problem+json":
			...
			var response GoneProblemDetails
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodePermissionsQueryEntitiesGrantsPostResponse(resp *http.Response) (res PermissionsQueryEntitiesGrantsPostRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response QueryEntityPermissionsResponse
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeTestdataContextBlockPostResponse(resp *http.Response) (res TestdataContextBlockPostRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &TestdataContextBlockPostOK{}, nil
	case 400:
		// Code 400.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
...
func decodeTestdataContextUnblockPostResponse(resp *http.Response) (res TestdataContextUnblockPostRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &TestdataContextUnblockPostOK{}, nil
	case 400:
		// Code 400.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
