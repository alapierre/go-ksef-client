...
API structure generated by `ogen-go` with fasade DefaultKsefClient and EncryptionService.

Very early project status - not ready for production use.

At this moment only an auth process with KSeF token is implemented in fasade DefaultKsefClient.